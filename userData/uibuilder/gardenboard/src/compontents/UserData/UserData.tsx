...
// @ts-ignore
import uibuilder from 'node-red-contrib-uibuilder/front-end/uibuilder.esm.min';

class UserData extends Component<any, any> {
  constructor(props: any) {
    ...
    /** **REQUIRED** Start uibuilder comms with Node-RED @since v2.0.0-dev3
         ...
         */
    // uibuilder.start();
    uibuilder.start(import.meta.env.BASE_URL);
    ...
    uibuilder.onChange('msg', (newVal: any) => {
    ...
    uibuilder.onChange('msgsReceived', (newVal: any) => {
    ...
    uibuilder.onChange('ctrlMsg', (newVal: any) => {
    ...
    uibuilder.onChange('msgsCtrl', (newVal: any) => {
    ...
    uibuilder.onChange('sentMsg', (newVal: any) => {
    ...
    uibuilder.onChange('msgsSent', (newVal: any) => {
    ...
    uibuilder.onChange('sentCtrlMsg', (newVal: any) => {
    ...
    uibuilder.onChange('msgsSentCtrl', (newVal: any) => {
    ...
    uibuilder.onChange('ioConnected', (newVal: any) => {
    ...
    uibuilder.onChange('serverTimeOffset', (newVal: any) => {
